...
public class AgregarDesdeAgenda extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_agregar_desde_agenda);
        db = new BaseDatos(AgregarDesdeAgenda.this);
        ...
        btnAddContacto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent Regresar = new Intent(AgregarDesdeAgenda.this, contactos.class);
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent Regresar = new Intent(AgregarDesdeAgenda.this, boton_emergencia.class);
                startActivity(Regresar);
                // finish(); //aqui*****
            }
        });
